...
#import dataset
movie <- read.csv("D:/MHM/R language/Complete ML in R/3. Decision Trees/Movie_regression.csv")
View(movie)
...
printcp(regtree)
fit$cptable[which.min(fit$cptable[,â..xerrorâ..]),â..CPâ..]
plotcp(regtree)
...
df <- read.csv("D:/MHM/R language/Complete ML in R/3. Decision Trees/Movie_classification.csv")
View(df)
