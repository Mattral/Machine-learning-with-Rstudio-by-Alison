...
movie <- read.csv("D:/MHM/R language/Complete ML in R/4. Support Vector Machines/Movie_classification.csv", header = TRUE)
...
df <- read.csv("D:/MHM/R language/Complete ML in R/4. Support Vector Machines/Movie_regression.csv", header = TRUE)
